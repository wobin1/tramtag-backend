...
class Startup(models.Model):
    ...
    founders = ArrayField(models.CharField(max_length=255), null=False, blank=True)
    additional_info = ArrayField(models.CharField(max_length=255), null=False, blank=True)
    def __str__(self):
